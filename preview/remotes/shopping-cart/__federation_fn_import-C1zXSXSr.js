...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BN8Au471.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-Dv6rxxlE.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-vayIoP7y.js', import.meta.url).href),import:true}};
