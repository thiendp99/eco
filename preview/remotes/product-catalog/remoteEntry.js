...
"./ProductList":()=>{
      ...
      return __federation_import('/eco/product-catalog/__federation_expose_ProductList-MhojKQ7A.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},
"./ProductDetail":()=>{
