...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BN8Au471.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-D7IdJM8l.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-DGuY3lfx.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-DrDXPsjs.js', import.meta.url).href),import:true},'@ecommerce/shared':{get:()=>()=>__federation_import(new URL('__federation_shared_@ecommerce/shared-RGl-QjZP.js', import.meta.url).href),import:true}};
