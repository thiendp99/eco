...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-BCcI129A.js', import.meta.url).href),import:true,requiredVersion:'18.2.0'},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-BN8Au471.js', import.meta.url).href),import:true,requiredVersion:'18.2.0'},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-DQcZejdR.js', import.meta.url).href),import:true},'zustand':{get:()=>()=>__federation_import(new URL('__federation_shared_zustand-_TN9rUqN.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-CNlfy7dF.js', import.meta.url).href),import:true},'@ecommerce/shared':{get:()=>()=>__federation_import(new URL('__federation_shared_@ecommerce/shared-CnrfoO0W.js', import.meta.url).href),import:true}};
