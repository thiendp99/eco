...
const remotesMap = {
'productCatalog':{url:'http://localhost:3001/assets/remoteEntry.js',format:'esm',from:'vite'},
  'shoppingCart':{url:'http://localhost:3002/assets/remoteEntry.js',format:'esm',from:'vite'}
};
