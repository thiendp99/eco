    ...
    <div className="mb-8">
      ...
      `}>
        ...
        `}>
          ...
          {/* Search - Full Width */}
          <div className="mb-5">
            <label className={`block text-xs font-semibold mb-2.5 uppercase tracking-wider ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
              Search Products
            </label>
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1">
                  <span className={`absolute left-4 top-1/2 -translate-y-1/2 text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
                    $
                  </span>
                  <input
                    type="number"
                ...
                <span className={`text-sm font-medium ${isDark ? 'text-gray-600' : 'text-gray-400'}`}>
                  —
                </span>
                <div className="relative flex-1">
                  <span className={`absolute left-4 top-1/2 -translate-y-1/2 text-sm font-medium ${isDark ? 'text-gray-500' : 'text-gray-400'}`}>
