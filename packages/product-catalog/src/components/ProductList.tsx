        ...
        >
          ...
          >
            {error instanceof Error
              ? error.message
              : 'Something went wrong while connecting to our servers. Please try again later.'}
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
        ...
        <div className="mb-10 lg:mb-16 animate-fade-up">
          ...
          >
            {isLoading
              ? 'Loading catalog...'
              : `${data?.total || 0} premium items available`}
          </p>
        </div>
                  ...
                  className={`
                    ...
                    ${
                      page === 1
                        ...
                        : isDark
                          ? 'text-white hover:bg-slate-800 bg-slate-900'
                          : 'text-gray-700 hover:bg-gray-100 bg-white shadow-sm border border-gray-100'
                    }
                  `}
                >
