      ...
      <div className="w-full flex items-center justify-center p-8 sm:p-12 lg:p-24 relative overflow-y-auto">
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full rounded-xl pl-11 pr-4 py-3.5 text-sm transition-all outline-none focus:ring-2 ${
                    isDark
            ...
            {error && (
              <div
                className={`rounded-xl px-4 py-3 text-sm flex items-center gap-2 animate-fade-in ${
                  isDark
