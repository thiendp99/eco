    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        `}>
          ...
          <div className={`flex justify-between mb-4 text-base ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
          ...
          <div className={`flex justify-between mb-6 text-base ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            <span>Tax (10%):</span>
            <span className={`font-semibold ${isDark ? 'text-white' : 'text-gray-900'}`}>
              ${tax.toFixed(2)}
            </span>
          ...
          <hr className={`my-6 border-2 ${isDark ? 'border-gray-700' : 'border-gray-300'}`} />
